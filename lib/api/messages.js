...
export const messageAPI = {
  ...
  // Authenticated user — retrieve own moderator application status (no admin notes)
  getMyModeratorApplication: async () => {
    return apiRequest('/api/messages/mine/moderator-application');
  },
