...
const DEFAULT_SETTINGS = {
  ...
  slides: [
    {
      id: 'default-slide-1',
      title: 'Η φωνή των ανεξάρτητων, οι αποφάσεις της κοινότητας.',
      subtitle: 'Ανεξάρτητοι υποψήφιοι και ενεργοί πολίτες γίνονται ορατοί και αποφασίζουν μαζί μέσα από ψηφοφορίες, προτάσεις και δημόσιες δεσμεύσεις.',
      linkUrl: '',
      linkText: '',
      isActive: true,
    },
    {
      id: 'default-slide-2',
      title: 'Κόμματα και οργανώσεις συμμετέχουν ισότιμα.',
      subtitle: 'Δημιουργήστε προφίλ οργανισμού, παρουσιάστε θέσεις και συμβάλετε στον δημόσιο διάλογο με διαφάνεια και λογοδοσία.',
      linkUrl: '/organizations',
      linkText: 'Δείτε οργανισμούς',
      isActive: true,
    },
  ],
};
