...
export const adminAPI = {
  ...
  getLegalWorkerStatus: async () => {
    return apiRequest('/api/admin/legal/worker');
  },

  importParliamentLaws: async (params = {}) => {
    return apiRequest('/api/admin/legal/import-parliament-laws', {
      method: 'POST',
