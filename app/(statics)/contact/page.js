...
export default function ContactPage() {
  ...
  return (
    <StaticPageLayout title={tStatic('contact_title')} maxWidth="max-w-2xl" breadcrumb={<Link href="/pages" className="text-gray-500 hover:text-blue-600 transition-colors">← {tStatic('pages')}</Link>}>
      <p className="text-gray-700 mb-6">
        {tStatic('contact_intro')}
      </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-semibold text-blue-900 mb-2">{tStatic('contact_discord_title')}</h3>
        <p className="text-blue-800 text-sm mb-3">
          {tStatic('contact_discord_description')}
        </p>
        <a
