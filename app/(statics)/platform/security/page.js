...
export default function SecurityPage() {
  return (
    ...
    >
      ...
      <section className="my-6 rounded-xl border border-teal-200 bg-teal-50 p-5">
        <h2 className="text-xl font-semibold">Συμμετοχή και ιδιωτικότητα ψήφου</h2>
        <p className="mt-2">Οι ψηφοφορίες είναι συμβουλευτικές. Η απόκρυψη ονόματος αφορά τους άλλους χρήστες και δεν αποτελεί μυστική ψηφοφορία: η πλατφόρμα διατηρεί ψήφους συνδεδεμένες με λογαριασμούς και τεχνικά δεδομένα. Η δηλωμένη περιοχή δεν είναι ανεξάρτητη απόδειξη κατοικίας. Οι διαχειριστές υπόκεινται στους ίδιους κανόνες τοπικής ψήφου και συμμετοχής σε οργανισμούς.</p>
        <p className="mt-2">Το ιστορικό προόδου διατηρεί τις ενημερώσεις συντακτών και διαχειριστών. Η αναφερόμενη ολοκλήρωση απαιτεί σύνδεσμο τεκμηρίωσης, αλλά δεν αποτελεί ανεξάρτητη πιστοποίηση.</p>
        <Link href="/progress" className="mt-3 inline-block font-semibold text-teal-800">Παρακολούθηση προόδου →</Link>
      </section>
      {/* Security Pillars */}
      <section>
