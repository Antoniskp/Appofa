...
/**
 * ShareModal — reusable sharing modal for a formation.
 *
 * Props:
...
export default function ShareModal({ formation, onClose, showToast }) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Κοινοποίηση σύνθεσης"
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 relative">
        ...
        {/* Header */}
        <h2 className="text-lg font-bold text-gray-900 mb-1">Κοινοποίηση Σύνθεσης</h2>
        <p className="text-sm text-gray-500 mb-5 truncate">{formation.name}</p>
