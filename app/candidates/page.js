...
function CandidateCard({ profile }) {
  return (
    <Link href={`/candidates/${profile.slug}`} className="block bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow overflow-hidden">
      <div className="p-5">
