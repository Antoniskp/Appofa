...
export default function AboutPage() {
  return (
    <StaticPageLayout title="Σχετικά με το Apofasi" maxWidth="max-w-4xl" breadcrumb={<Link href="/pages" className="text-gray-500 hover:text-blue-600 transition-colors">← Σελίδες</Link>}>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-3">Τεχνολογία & Διαφάνεια Κώδικα</h2>
        
        <p className="text-gray-700 mb-4">
          Η πλατφόρμα είναι χτισμένη με σύγχρονες τεχνολογίες. Ο κώδικας είναι δημοσίως διαθέσιμος
          αποκλειστικά για λόγους διαφάνειας και ελέγχου ασφαλείας — δεν πρόκειται για λογισμικό
          ανοιχτού κώδικα (open source). Όλα τα δικαιώματα ανήκουν στον Antoniskp.
        </p>
