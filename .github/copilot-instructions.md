...
- **i18n**: use `next-intl` with root `i18n.js`; resolve locale from `NEXT_LOCALE` cookie (`el` default, valid: `el`/`en`)
- **Language switcher**: use `components/ui/LanguageSwitcher.js` in TopNav to set `NEXT_LOCALE` and reload
