...
export default function TopNav() {
  ...
  return (
    ...
    >
      <div className="app-container">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="hidden xl:ml-6 xl:flex xl:items-center xl:gap-2">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-md p-2 text-blue-900 hover:bg-seafoam/40 xl:hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
      ...
      <div className={`xl:hidden ${isMenuOpen ? 'block' : 'hidden'} max-h-[calc(100dvh-8rem)] overflow-y-auto`} id="mobile-menu">
