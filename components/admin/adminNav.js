...
export const adminNavSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/legal', label: 'Greek Laws', icon: ScaleIcon, roles: ADMIN_ROLES },
      { href: '/admin/media', label: 'Media Library', icon: PhotoIcon, roles: ADMIN_ROLES, translationKey: 'media_title' },
      { href: '/admin/topics', label: 'Topics', icon: TagIcon, roles: STAFF_ROLES },
