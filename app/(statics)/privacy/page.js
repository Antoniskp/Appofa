...
export default function PrivacyPage() {
  return (
    <StaticPageLayout title="Πολιτική Απορρήτου" maxWidth="max-w-4xl" breadcrumb={<Link href="/pages" className="text-gray-500 hover:text-blue-600 transition-colors">← Σελίδες</Link>}>
      <section>
