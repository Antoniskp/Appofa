    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="app-container">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-gray-500">Learn about people before voting</p>
        </div>
        ...
        {error && (
          <EmptyState
            ...
            description="Could not load profiles. Please try again."
            action={{ text: 'Retry', onClick: () => window.location.reload() }}
          />
        )}

        {!initialLoading && !error && persons.length === 0 && (
          <EmptyState message="No people found matching your filters." />
        )}
