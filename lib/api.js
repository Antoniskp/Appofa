 ...
 */
export const moderatorApplicationAPI = {
  create: async (applicationData) => {
    return apiRequest('/api/moderator-applications', {
      method: 'POST',
  ...
  createContact: async (contactData) => {
    return apiRequest('/api/moderator-applications/contact', {
      method: 'POST',
  ...
  getAll: async (params = {}) => {
    return apiRequest(buildQueryEndpoint('/api/moderator-applications', params));
  },
  
  updateStatus: async (id, status, notes) => {
    return apiRequest(`/api/moderator-applications/${id}/status`, {
      method: 'PUT',
